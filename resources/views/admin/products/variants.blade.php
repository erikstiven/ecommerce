<x-admin-layout :breadcrumbs="[
    ...
    <form action="{{ route('admin.products.variantsUpdate', [$product, $variant]) }}" method="POST"
        ...
        <div class="relative mb-6">
            <figure>
                <img class="aspect-[1/1] w-full object-cover object-center" src="{{ asset($variant->image) }}"
                    alt="{{ $variant->features->pluck('description')->implode(', ') }}" id="imgPreview">
            </figure>
        ...
        <div class="card">
            <div class="mb-4">
                <x-label class="mb-1">Código (SKU)</x-label>
