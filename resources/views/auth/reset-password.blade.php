<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="mt-4">
                <x-label for="password" value="Nueva contraseña" class="text-white/90 font-medium" />
                <x-input id="password" class="block mt-1 w-full text-black"
                         type="password" name="password" required autocomplete="new-password" />
            </div>

            <div class="mt-4">
                <x-label for="password_confirmation" value="Confirmar contraseña" class="text-white/90 font-medium" />
