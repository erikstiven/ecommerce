    ...
    <x-authentication-card width="sm:max-w-2xl">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="grid grid-cols-2  gap-4">
                ...
                {{-- Dcoumento --}}
                <div>
                    <x-label for="document" value="Documento" class="text-white/90 font-medium" />
                ...
                <div>
                    <x-label for="password_confirmation" value="{{ __('Confirm Password') }}" class="text-white/90 font-medium"  />
