          ...
          <div class="grid md:grid-cols-2 gap-6">
              ...
              <div class="col-span-1">
                  ...
                  <div class="flex items-center space-x-6 mb-6" x-data="{
                      ...
                      <button class="btn btn-gradient-gray" x-on:click="qty = qty + 1">
                          +
                      </button>
                                  ...
                                  @foreach ($option->pivot->features as $feature)
                                      <li>
                                          ...
                                          @switch($option->type)
                                              ...
                                              @case(2)
                                                  <div class="p-0.5 border-2 rounded-lg flex items-center -mt-1.5 space-x-2 {{ $selectedFeatures[$option->id] == $feature['id'] ? 'border-purple-600' : 'border-transparent' }}" >
                  ...
                  <button class="btn btn-gradient-purple w-full mb-6" 
